...
import { CallManagementModal } from "@/components/CallManagementModal";
    ...
    <>
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="flagged">Problematic & Critical</SelectItem>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base">
              {rows.length} groups with overdue balance · {fmtEur(totalOverdue)} total overdue
            </CardTitle>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-8 text-sm text-muted-foreground">No groups found</div>
            ) : (
              <div className="overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {rows.map((r, idx) => (
                      <TableRow key={r.group} className="cursor-pointer hover:bg-muted/50" onClick={() => setSelectedGroup(r)}>
      ...
      {selectedGroup && (
        <CallManagementModal
          ...
          contact: selectedGroup.contacts[0] ? {
            email: selectedGroup.contacts[0].email ?? undefined,
            phone: selectedGroup.contacts[0].phone ?? undefined,
            } : undefined,
          }}
        />
      )}
